...
template <> void RecordablesMap<pp_pop_psc_delta>::create() {
...
nest::pp_pop_psc_delta::State_::State_()
    : y0_(0.0), h_(0.0), p_age_occupations_(0), p_n_spikes_past_(0),
      initialized_(false) {
...
nest::pp_pop_psc_delta::Buffers_::Buffers_(pp_pop_psc_delta &n) : logger_(n) {}
...
nest::pp_pop_psc_delta::pp_pop_psc_delta() : Node(), P_(), S_(), B_(*this) {
...
void nest::pp_pop_psc_delta::update(Time const &origin, const long from,
                                    const long to) {
