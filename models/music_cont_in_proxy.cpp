...
nest::music_cont_in_proxy::Parameters_::Parameters_() : port_name_("cont_in") {}
...
void nest::music_cont_in_proxy::Parameters_::set(const DictionaryDatum &d,
                                                 State_ &s) {
...
void nest::music_cont_in_proxy::State_::set(const DictionaryDatum &,
                                            const Parameters_ &) {}
...
nest::music_cont_in_proxy::music_cont_in_proxy() : DeviceNode(), P_(), S_() {}
