...
template <> void RecordablesMap<sinusoidal_poisson_generator>::create() {
...
nest::sinusoidal_poisson_generator::Parameters_::Parameters_(
    const Parameters_ &p)
    : om_(p.om_), phi_(p.phi_), rate_(p.rate_), amplitude_(p.amplitude_),
...
nest::sinusoidal_poisson_generator::Buffers_::Buffers_(
    const Buffers_ &, sinusoidal_poisson_generator &n)
    : logger_(n) {}
...
void nest::sinusoidal_poisson_generator::Parameters_::get(
...
void nest::sinusoidal_poisson_generator::Parameters_::set(
    const DictionaryDatum &d, const sinusoidal_poisson_generator &n) {
  ...
  updateValue<bool>(d, names::individual_spike_trains,
