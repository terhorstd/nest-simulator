...
void nest::music_event_out_proxy::Parameters_::set(const DictionaryDatum &d,
                                                   State_ &s) {
...
void nest::music_event_out_proxy::State_::set(const DictionaryDatum &,
                                              const Parameters_ &) {}
...
void nest::music_event_out_proxy::calibrate() {
  ...
  if (not S_.published_) {
    ...
    V_.music_perm_ind_ = new MUSIC::PermutationIndex(&V_.index_map_.front(),
                                                     V_.index_map_.size());
