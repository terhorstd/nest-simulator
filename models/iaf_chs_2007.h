...
inline port iaf_chs_2007::send_test_event(Node &target, rport receptor_type,
                                          synindex, bool) {
  SpikeEvent e;
  e.set_sender(*this);
...
inline port iaf_chs_2007::handles_test_event(SpikeEvent &, port receptor_type) {
  if (receptor_type != 0) {
...
inline port iaf_chs_2007::handles_test_event(DataLoggingRequest &dlr,
                                             port receptor_type) {
  if (receptor_type != 0) {
    throw UnknownReceptorType(receptor_type, get_name());
  }
...
inline void iaf_chs_2007::get_status(DictionaryDatum &d) const {
  P_.get(d);
  S_.get(d);
...
inline void iaf_chs_2007::set_status(const DictionaryDatum &d) {
