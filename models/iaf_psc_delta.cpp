...
template <> void RecordablesMap<iaf_psc_delta>::create() {
...
nest::iaf_psc_delta::State_::State_()
    : y0_(0.0), y3_(0.0), r_(0), refr_spikes_buffer_(0.0) {}
...
nest::iaf_psc_delta::Buffers_::Buffers_(iaf_psc_delta &n) : logger_(n) {}
...
nest::iaf_psc_delta::iaf_psc_delta() : Archiving_Node(), P_(), S_(), B_(*this) {
...
void nest::iaf_psc_delta::update(Time const &origin, const long from,
                                 const long to) {
