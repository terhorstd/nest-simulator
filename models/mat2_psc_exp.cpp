 ...
 */
template <> void RecordablesMap<mat2_psc_exp>::create() {
...
nest::mat2_psc_exp::State_::State_()
    : i_0_(0.0), i_syn_ex_(0.0), i_syn_in_(0.0), V_m_(0.0),
...
double nest::mat2_psc_exp::Parameters_::set(const DictionaryDatum &d) {
  ...
  if (Tau_ <= 0 || tau_ex_ <= 0 || tau_in_ <= 0 || tau_ref_ <= 0 ||
      tau_1_ <= 0 || tau_2_ <= 0) {
...
void nest::mat2_psc_exp::State_::get(DictionaryDatum &d,
                                     const Parameters_ &p) const {
  def<double>(d, names::V_m, V_m_ + p.E_L_); // Membrane potential
  def<double>(d, names::V_th,
...
void nest::mat2_psc_exp::State_::set(const DictionaryDatum &d,
...
nest::mat2_psc_exp::Buffers_::Buffers_(mat2_psc_exp &n) : logger_(n) {
...
nest::mat2_psc_exp::mat2_psc_exp() : Archiving_Node(), P_(), S_(), B_(*this) {
...
void nest::mat2_psc_exp::update(Time const &origin, const long from,
                                const long to) {
...
void nest::mat2_psc_exp::handle(DataLoggingRequest &e) { B_.logger_.handle(e); }
