...
template <typename targetidentifierT>
inline void
ClopathConnection<targetidentifierT>::send(Event &e, thread t,
...
ClopathConnection<targetidentifierT>::ClopathConnection()
    : ConnectionBase(), weight_(1.0), x_bar_(0.0), tau_x_(15.0), Wmin_(0.0),
      Wmax_(100.0), t_lastspike_(0.0) {}

template <typename targetidentifierT>
ClopathConnection<targetidentifierT>::ClopathConnection(
    const ClopathConnection<targetidentifierT> &rhs)
    : ConnectionBase(rhs), weight_(rhs.weight_), x_bar_(rhs.x_bar_),
      tau_x_(rhs.tau_x_), Wmin_(rhs.Wmin_), Wmax_(rhs.Wmax_),
      t_lastspike_(rhs.t_lastspike_) {}

template <typename targetidentifierT>
void ClopathConnection<targetidentifierT>::get_status(
...
template <typename targetidentifierT>
void ClopathConnection<targetidentifierT>::set_status(const DictionaryDatum &d,
                                                      ConnectorModel &cm) {
