...
nest::gamma_sup_generator::Internal_states_::Internal_states_(
    size_t num_bins, unsigned long ini_occ_ref, unsigned long ini_occ_act) {
...
nest::gamma_sup_generator::Parameters_::Parameters_()
    : rate_(0.0) // Hz
      ,
      gamma_shape_(1), n_proc_(1), num_targets_(0) {}
...
void nest::gamma_sup_generator::init_buffers_() { device_.init_buffers(); }
...
void nest::gamma_sup_generator::calibrate() {
  ...
  Internal_states_ internal_states0(P_.gamma_shape_, ini_occ_0,
                                    P_.n_proc_ - ini_occ_0 * P_.gamma_shape_);
...
void nest::gamma_sup_generator::update(Time const &T, const long from,
                                       const long to) {
