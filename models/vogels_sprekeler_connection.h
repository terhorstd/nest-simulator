 ...
 */
template <typename targetidentifierT>
inline void VogelsSprekelerConnection<targetidentifierT>::send(
...
VogelsSprekelerConnection<targetidentifierT>::VogelsSprekelerConnection()
    : ConnectionBase(), weight_(0.5), tau_(20.0), alpha_(0.12), eta_(0.001),
      Wmax_(1.0), Kplus_(0.0), t_lastspike_(0.0) {}

template <typename targetidentifierT>
VogelsSprekelerConnection<targetidentifierT>::VogelsSprekelerConnection(
    const VogelsSprekelerConnection<targetidentifierT> &rhs)
    : ConnectionBase(rhs), weight_(rhs.weight_), tau_(rhs.tau_),
      alpha_(rhs.alpha_), eta_(rhs.eta_), Wmax_(rhs.Wmax_), Kplus_(rhs.Kplus_),
      t_lastspike_(rhs.t_lastspike_) {}

template <typename targetidentifierT>
void VogelsSprekelerConnection<targetidentifierT>::get_status(
...
template <typename targetidentifierT>
void VogelsSprekelerConnection<targetidentifierT>::set_status(
