...
template <> void RecordablesMap<iaf_psc_exp>::create() {
...
nest::iaf_psc_exp::State_::State_()
    : i_0_(0.0), i_syn_ex_(0.0), i_syn_in_(0.0), V_m_(0.0), r_ref_(0) {}
...
void nest::iaf_psc_exp::State_::get(DictionaryDatum &d,
...
nest::iaf_psc_exp::Buffers_::Buffers_(iaf_psc_exp &n) : logger_(n) {}
...
nest::iaf_psc_exp::iaf_psc_exp() : Archiving_Node(), P_(), S_(), B_(*this) {
...
void nest::iaf_psc_exp::update(const Time &origin, const long from,
                               const long to) {
...
void nest::iaf_psc_exp::handle(DataLoggingRequest &e) { B_.logger_.handle(e); }
