...
nest::spin_detector::spin_detector()
    : DeviceNode(),
      device_(*this, RecordingDevice::SPIN_DETECTOR, "gdf", true, true,
              true) // record time, gid and weight (used for spin)
      ,
      last_in_gid_(0), t_last_in_spike_(Time::neg_inf()) {}

nest::spin_detector::spin_detector(const spin_detector &n)
    : DeviceNode(n), device_(*this, n.device_), last_in_gid_(0),
...
void nest::spin_detector::update(Time const &, const long, const long) {
