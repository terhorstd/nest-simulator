 ...
 */
template <> void RecordablesMap<iaf_chxk_2008>::create() {
  // use standard names wherever you can for consistency!
  insert_(names::V_m, &iaf_chxk_2008::get_y_elem_<iaf_chxk_2008::State_::V_M>);
  insert_(names::g_ex,
          &iaf_chxk_2008::get_y_elem_<iaf_chxk_2008::State_::G_EXC>);
  insert_(names::g_in,
          &iaf_chxk_2008::get_y_elem_<iaf_chxk_2008::State_::G_INH>);
  insert_(names::g_ahp,
          &iaf_chxk_2008::get_y_elem_<iaf_chxk_2008::State_::G_AHP>);
...
nest::iaf_chxk_2008::State_::State_(const Parameters_ &p) : r(0) {
...
nest::iaf_chxk_2008::State_::State_(const State_ &s) : r(s.r) {
  for (size_t i = 0; i < STATE_VEC_SIZE; ++i) {
    y[i] = s.y[i];
  }
}

nest::iaf_chxk_2008::State_ &nest::iaf_chxk_2008::State_::
...
void nest::iaf_chxk_2008::update(Time const &origin, const long from,
                                 const long to) {
