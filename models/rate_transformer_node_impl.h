...
template <class TNonlinearities>
nest::rate_transformer_node<TNonlinearities>::State_::State_() : rate_(0.0) {}
...
template <class TNonlinearities>
void nest::rate_transformer_node<TNonlinearities>::Parameters_::get(
    DictionaryDatum &d) const {
  def<bool>(d, names::linear_summation, linear_summation_);
}

template <class TNonlinearities>
void nest::rate_transformer_node<TNonlinearities>::Parameters_::set(
    const DictionaryDatum &d) {
  updateValue<bool>(d, names::linear_summation, linear_summation_);
}

template <class TNonlinearities>
void nest::rate_transformer_node<TNonlinearities>::State_::get(
    DictionaryDatum &d) const {
  def<double>(d, names::rate, rate_); // Rate
}

template <class TNonlinearities>
void nest::rate_transformer_node<TNonlinearities>::State_::set(
    const DictionaryDatum &d) {
...
template <class TNonlinearities>
nest::rate_transformer_node<TNonlinearities>::Buffers_::Buffers_(
    const Buffers_ &, rate_transformer_node<TNonlinearities> &n)
    : logger_(n) {}
...
nest::rate_transformer_node<TNonlinearities>::rate_transformer_node(
    ...
    : Archiving_Node(n), nonlinearities_(n.nonlinearities_), S_(n.S_),
      B_(n.B_, *this) {
  Node::set_node_uses_wfr(kernel().simulation_manager.use_wfr());
}
...
template <class TNonlinearities>
void nest::rate_transformer_node<TNonlinearities>::init_state_(
    const Node &proto) {
...
template <class TNonlinearities>
void nest::rate_transformer_node<TNonlinearities>::init_buffers_() {
...
template <class TNonlinearities>
void nest::rate_transformer_node<TNonlinearities>::calibrate() {
  B_.logger_
...
template <class TNonlinearities>
bool nest::rate_transformer_node<TNonlinearities>::update_(
...
template <class TNonlinearities>
void nest::rate_transformer_node<TNonlinearities>::handle(
