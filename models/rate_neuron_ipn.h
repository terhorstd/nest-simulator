 ...
 */
template <class TNonlinearities> class rate_neuron_ipn : public Archiving_Node {
...
inline void rate_neuron_ipn<TNonlinearities>::update(Time const &origin,
                                                     const long from,
                                                     const long to) {
...
template <class TNonlinearities>
inline bool rate_neuron_ipn<TNonlinearities>::wfr_update(Time const &origin,
                                                         const long from,
                                                         const long to) {
...
template <class TNonlinearities>
inline port rate_neuron_ipn<TNonlinearities>::handles_test_event(
