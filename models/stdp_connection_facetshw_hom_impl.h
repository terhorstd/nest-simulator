...
STDPFACETSHWHomCommonProperties<
    ...
    : CommonSynapseProperties(), tau_plus_(20.0), tau_minus_(20.0),
      Wmax_(100.0), no_synapses_(0),
...
template <typename targetidentifierT>
void STDPFACETSHWHomCommonProperties<
...
template <typename targetidentifierT>
void STDPFACETSHWHomCommonProperties<targetidentifierT>::get_status(
...
template <typename targetidentifierT>
void STDPFACETSHWHomCommonProperties<targetidentifierT>::set_status(
  ...
  updateValue<double>(d, names::readout_cycle_duration,
                      readout_cycle_duration_);
  ...
  if (updateValue<double>(d, names::driver_readout_time,
                          driver_readout_time_)) {
    calc_readout_cycle_duration_();
  }
...
STDPFACETSHWConnectionHom<targetidentifierT>::STDPFACETSHWConnectionHom()
    : weight_(1.0), a_causal_(0.0), a_acausal_(0.0), a_thresh_th_(21.835),
      a_thresh_tl_(21.835) // exp(-10ms/20ms) * 36SSPs
      ,
      init_flag_(false), synapse_id_(0), next_readout_time_(0.0),
      discrete_weight_(0), t_lastspike_(0.0) {}

template <typename targetidentifierT>
STDPFACETSHWConnectionHom<targetidentifierT>::STDPFACETSHWConnectionHom(
    const STDPFACETSHWConnectionHom &rhs)
    : ConnectionBase(rhs), weight_(rhs.weight_), a_causal_(rhs.a_causal_),
      a_acausal_(rhs.a_acausal_), a_thresh_th_(rhs.a_thresh_th_),
      a_thresh_tl_(rhs.a_thresh_tl_), init_flag_(rhs.init_flag_),
      synapse_id_(rhs.synapse_id_), next_readout_time_(rhs.next_readout_time_),
      discrete_weight_(rhs.discrete_weight_), t_lastspike_(rhs.t_lastspike_) {}

template <typename targetidentifierT>
void STDPFACETSHWConnectionHom<targetidentifierT>::get_status(
    DictionaryDatum &d) const {
...
template <typename targetidentifierT>
void STDPFACETSHWConnectionHom<targetidentifierT>::set_status(
    const DictionaryDatum &d, ConnectorModel &cm) {
