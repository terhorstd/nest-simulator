...
template <> void RecordablesMap<iaf_chs_2007>::create() {
...
nest::iaf_chs_2007::State_::State_()
    : i_syn_ex_(0.0), V_syn_(0.0), V_spike_(0.0), V_m_(0.0) {}
...
nest::iaf_chs_2007::Buffers_::Buffers_(iaf_chs_2007 &n) : logger_(n) {}
...
nest::iaf_chs_2007::iaf_chs_2007() : Archiving_Node(), P_(), S_(), B_(*this) {
...
void nest::iaf_chs_2007::update(const Time &origin, const long from,
                                const long to) {
...
void nest::iaf_chs_2007::handle(DataLoggingRequest &e) { B_.logger_.handle(e); }
