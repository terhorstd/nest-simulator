...
nest::mip_generator::mip_generator() : DeviceNode(), device_(), P_() {}

nest::mip_generator::mip_generator(const mip_generator &n)
    : DeviceNode(n), device_(n.device_),
...
void nest::mip_generator::init_buffers_() { device_.init_buffers(); }
...
void nest::mip_generator::update(Time const &T, const long from,
                                 const long to) {
