...
nest::rate_neuron_opn<TNonlinearities>::Parameters_::Parameters_()
    : tau_(10.0) // ms
      ,
      sigma_(1.0), mu_(0.0), linear_summation_(true), mult_coupling_(false) {
  recordablesMap_.create();
}

template <class TNonlinearities>
nest::rate_neuron_opn<TNonlinearities>::State_::State_()
    : rate_(0.0), noise_(0.0), noisy_rate_(0.0) {}
...
template <class TNonlinearities>
void nest::rate_neuron_opn<TNonlinearities>::Parameters_::get(
...
template <class TNonlinearities>
void nest::rate_neuron_opn<TNonlinearities>::Parameters_::set(
...
template <class TNonlinearities>
void nest::rate_neuron_opn<TNonlinearities>::State_::get(
    DictionaryDatum &d) const {
...
template <class TNonlinearities>
void nest::rate_neuron_opn<TNonlinearities>::State_::set(
    const DictionaryDatum &d) {
...
template <class TNonlinearities>
nest::rate_neuron_opn<TNonlinearities>::Buffers_::Buffers_(
    const Buffers_ &, rate_neuron_opn<TNonlinearities> &n)
    : logger_(n) {}
...
template <class TNonlinearities>
void nest::rate_neuron_opn<TNonlinearities>::init_state_(const Node &proto) {
  const rate_neuron_opn &pr = downcast<rate_neuron_opn>(proto);
  S_ = pr.S_;
}

template <class TNonlinearities>
void nest::rate_neuron_opn<TNonlinearities>::init_buffers_() {
...
template <class TNonlinearities>
void nest::rate_neuron_opn<TNonlinearities>::calibrate() {
  B_.logger_
  ...
  V_.output_noise_factor_ = std::sqrt(
      P_.tau_ /
...
template <class TNonlinearities>
bool nest::rate_neuron_opn<TNonlinearities>::update_(
...
template <class TNonlinearities>
void nest::rate_neuron_opn<TNonlinearities>::handle(
...
template <class TNonlinearities>
void nest::rate_neuron_opn<TNonlinearities>::handle(DataLoggingRequest &e) {
  B_.logger_.handle(e);
}
