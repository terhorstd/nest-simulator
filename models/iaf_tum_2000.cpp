...
template <> void RecordablesMap<iaf_tum_2000>::create() {
...
nest::iaf_tum_2000::State_::State_()
    : i_0_(0.0), i_syn_ex_(0.0), i_syn_in_(0.0), V_m_(0.0), r_abs_(0),
      r_tot_(0) {}
...
nest::iaf_tum_2000::Buffers_::Buffers_(iaf_tum_2000 &n) : logger_(n) {}
...
nest::iaf_tum_2000::iaf_tum_2000() : Archiving_Node(), P_(), S_(), B_(*this) {
...
void nest::iaf_tum_2000::update(Time const &origin, const long from,
                                const long to) {
...
void nest::iaf_tum_2000::handle(DataLoggingRequest &e) { B_.logger_.handle(e); }
