...
void nonlinearities_lin_rate::get(DictionaryDatum &d) const {
...
void nonlinearities_lin_rate::set(const DictionaryDatum &d) {
 ...
 */
template <> void RecordablesMap<nest::lin_rate_ipn>::create() {
  // use standard names whereever you can for consistency!
  insert_(names::rate, &nest::lin_rate_ipn::get_rate_);
  insert_(names::noise, &nest::lin_rate_ipn::get_noise_);
}

template <> void RecordablesMap<nest::lin_rate_opn>::create() {
  // use standard names whereever you can for consistency!
...
template <> void RecordablesMap<nest::rate_transformer_lin>::create() {
  // use standard names whereever you can for consistency!
