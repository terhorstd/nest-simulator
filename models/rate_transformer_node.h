...
template <class TNonlinearities>
inline void rate_transformer_node<TNonlinearities>::update(Time const &origin,
                                                           const long from,
                                                           const long to) {
...
template <class TNonlinearities>
inline bool rate_transformer_node<TNonlinearities>::wfr_update(
...
template <class TNonlinearities>
inline port rate_transformer_node<TNonlinearities>::handles_test_event(
