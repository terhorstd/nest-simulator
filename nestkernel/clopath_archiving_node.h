...
public:
   ...
   */
  void get_LTP_history(double t1, double t2,
...
protected:
   ...
   */
  void write_LTD_history(const double t_ltd_ms, double u_bar_minus,
                         double u_bar_bar);
   ...
   */
  void write_clopath_history(Time const &t_sp, double u, double u_bar_plus,
                             double u_bar_minus, double u_bar_bar);
...
inline double Clopath_Archiving_Node::get_theta_plus() const {
  return theta_plus_;
}

inline double Clopath_Archiving_Node::get_theta_minus() const {
  return theta_minus_;
}
