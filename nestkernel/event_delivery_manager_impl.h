...
inline void EventDeliveryManager::send_local_(Node &source, EventT &e,
                                              const long lag) {
...
template <class EventT>
inline void EventDeliveryManager::send(Node &source, EventT &e,
                                       const long lag) {
  send_local_(source, e, lag);
}

template <>
inline void EventDeliveryManager::send<SpikeEvent>(Node &source, SpikeEvent &e,
                                                   const long lag) {
...
template <>
inline void EventDeliveryManager::send<DSSpikeEvent>(Node &source,
                                                     DSSpikeEvent &e,
                                                     const long lag) {
...
inline void EventDeliveryManager::send_remote(thread tid, SpikeEvent &e,
                                              const long lag) {
...
inline void EventDeliveryManager::send_off_grid_remote(thread tid,
                                                       SpikeEvent &e,
                                                       const long lag) {
  // Put the spike in a buffer for the remote machines
  const index lid = kernel().vp_manager.gid_to_lid(e.get_sender().get_gid());
...
inline void EventDeliveryManager::send_secondary(const Node &source,
                                                 SecondaryEvent &e) {
...
inline size_t EventDeliveryManager::write_toggle() const {
