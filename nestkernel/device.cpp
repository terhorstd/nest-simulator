...
nest::Device::Parameters_::Parameters_()
    : origin_(Time::step(0)), start_(Time::step(0)), stop_(Time::pos_inf()) {}

nest::Device::Parameters_::Parameters_(const Parameters_ &p)
    : origin_(p.origin_), start_(p.start_), stop_(p.stop_) {
...
void nest::Device::Parameters_::update_(const DictionaryDatum &d,
                                        const Name &name, Time &value) {
...
nest::Device::Device() : P_() {}

nest::Device::Device(const Device &n) : P_(n.P_) {}
