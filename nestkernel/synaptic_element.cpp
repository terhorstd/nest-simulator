...
nest::SynapticElement::SynapticElement()
    : z_(0.0), z_t_(0.0), z_connected_(0), continuous_(true), growth_rate_(1.0),
      tau_vacant_(0.1), growth_curve_(new GrowthCurveLinear) {}

nest::SynapticElement::SynapticElement(const SynapticElement &se)
    : z_(se.z_), z_t_(se.z_t_), z_connected_(se.z_connected_),
      continuous_(se.continuous_), growth_rate_(se.growth_rate_),
...
nest::SynapticElement &nest::SynapticElement::
operator=(const SynapticElement &other) {
  if (this != &other) {
 ...
 * ---------------------------------------------------------------- */
void nest::SynapticElement::get(DictionaryDatum &d) const {
 ...
 * ---------------------------------------------------------------- */
void nest::SynapticElement::set(const DictionaryDatum &d) {
 ...
 * ---------------------------------------------------------------- */
void nest::SynapticElement::update(double t, double t_minus, double Ca_minus,
                                   double tau_Ca) {
  if (z_t_ != t_minus) {
    throw KernelException("Last update of the calcium concentration does not "
