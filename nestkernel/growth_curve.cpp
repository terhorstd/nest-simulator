...
nest::GrowthCurveLinear::GrowthCurveLinear()
    : GrowthCurve(names::linear), eps_(0.7) {}

void nest::GrowthCurveLinear::get(DictionaryDatum &d) const {
  def<std::string>(d, names::growth_curve, name_.toString());
  def<double>(d, names::eps, eps_);
}

void nest::GrowthCurveLinear::set(const DictionaryDatum &d) {
  updateValue<double>(d, names::eps, eps_);
}

double nest::GrowthCurveLinear::update(double t, double t_minus,
                                       double Ca_minus, double z_minus,
                                       double tau_Ca,
...
nest::GrowthCurveGaussian::GrowthCurveGaussian()
    : GrowthCurve(names::gaussian), eta_(0.1), eps_(0.7) {}

void nest::GrowthCurveGaussian::get(DictionaryDatum &d) const {
  def<std::string>(d, names::growth_curve, name_.toString());
  def<double>(d, names::eps, eps_);
  def<double>(d, names::eta, eta_);
}

void nest::GrowthCurveGaussian::set(const DictionaryDatum &d) {
  updateValue<double>(d, names::eps, eps_);
  updateValue<double>(d, names::eta, eta_);
}

double nest::GrowthCurveGaussian::update(double t, double t_minus,
                                         double Ca_minus, double z_minus,
                                         double tau_Ca,
                                         double growth_rate) const {
...
nest::GrowthCurveSigmoid::GrowthCurveSigmoid()
    : GrowthCurve(names::sigmoid), eps_(0.7), psi_(0.1) {}

void nest::GrowthCurveSigmoid::get(DictionaryDatum &d) const {
  def<std::string>(d, names::growth_curve, name_.toString());
  def<double>(d, names::eps, eps_);
  def<double>(d, names::psi, psi_);
}

void nest::GrowthCurveSigmoid::set(const DictionaryDatum &d) {
  updateValue<double>(d, names::eps, eps_);
...
double nest::GrowthCurveSigmoid::update(double t, double t_minus,
                                        double Ca_minus, double z_minus,
                                        double tau_Ca,
                                        double growth_rate) const {
  // Numerical integration from t_minus to t
