...
CommonSynapseProperties::CommonSynapseProperties() : weight_recorder_(0) {}

CommonSynapseProperties::~CommonSynapseProperties() {}

void CommonSynapseProperties::get_status(DictionaryDatum &d) const {
  def<long>(d, names::weight_recorder,
            weight_recorder_ ? weight_recorder_->get_gid() : -1);
}

void CommonSynapseProperties::set_status(const DictionaryDatum &d,
                                         ConnectorModel &) {
  long wrgid;
