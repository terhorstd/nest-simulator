...
nest::Clopath_Archiving_Node::Clopath_Archiving_Node()
    : Archiving_Node(), A_LTD_(14.0e-5), A_LTP_(8.0e-5), u_ref_squared_(60.0),
      theta_plus_(-45.3), theta_minus_(-70.6), A_LTD_const_(true),
      delay_u_bars_(5.0), ltd_hist_len_(0), ltd_hist_current_(0) {}

nest::Clopath_Archiving_Node::Clopath_Archiving_Node(
    const Clopath_Archiving_Node &n)
    : Archiving_Node(n), A_LTD_(n.A_LTD_), A_LTP_(n.A_LTP_),
      u_ref_squared_(n.u_ref_squared_), theta_plus_(n.theta_plus_),
      theta_minus_(n.theta_minus_), A_LTD_const_(n.A_LTD_const_),
      delay_u_bars_(n.delay_u_bars_), ltd_hist_len_(n.ltd_hist_len_),
      ltd_hist_current_(n.ltd_hist_current_) {}

void nest::Clopath_Archiving_Node::init_clopath_buffers() {
...
void nest::Clopath_Archiving_Node::get_status(DictionaryDatum &d) const {
...
void nest::Clopath_Archiving_Node::set_status(const DictionaryDatum &d) {
...
double nest::Clopath_Archiving_Node::get_LTD_value(double t) {
...
void nest::Clopath_Archiving_Node::get_LTP_history(
    double t1, double t2, std::deque<histentry_cl>::iterator *start,
...
void nest::Clopath_Archiving_Node::write_clopath_history(Time const &t_sp,
                                                         double u,
                                                         double u_bar_plus,
                                                         double u_bar_minus,
                                                         double u_bar_bar) {
...
void nest::Clopath_Archiving_Node::write_LTD_history(const double t_ltd_ms,
                                                     double u_bar_minus,
                                                     double u_bar_bar) {
  if (n_incoming_) {
...
void nest::Clopath_Archiving_Node::write_LTP_history(const double t_ltp_ms,
                                                     double u,
                                                     double u_bar_plus) {
  if (n_incoming_) {
