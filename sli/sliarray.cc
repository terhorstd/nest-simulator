...
void SLIArrayModule::SortFunction::execute(SLIInterpreter *i) const {
  ...
  i->message(SLIInterpreter::M_ERROR, "Sort",
...
void SLIArrayModule::ArraycreateFunction::execute(SLIInterpreter *i) const {
  ...
  if (i->OStack.load() == 0) {
    i->message(SLIInterpreter::M_ERROR, "arraycreate",
...
void SLIArrayModule::IMap_ivFunction::backtrace(SLIInterpreter *i,
                                                int p) const {
  IntegerDatum *id = static_cast<IntegerDatum *>(i->EStack.pick(p + 3).datum());
  assert(id != NULL);
  ...
  if (pos == 0) {
    if (iterator < limit) // Is Iteration is still running
    {
      if (iterator > 0) {
        ...
        if (not result) {
          i->dec_call_depth();
          i->message(SLIInterpreter::M_ERROR, "Map_iv",
...
void SLIArrayModule::IMap_dvFunction::backtrace(SLIInterpreter *i,
                                                int p) const {
  IntegerDatum *id = static_cast<IntegerDatum *>(i->EStack.pick(p + 3).datum());
  assert(id != NULL);
  ...
  if (pos == 0) {
    if (iterator < limit) // Is Iteration is still running
    {
      if (iterator > 0) {
        ...
        if (not result) {
          i->dec_call_depth();
          i->message(SLIInterpreter::M_ERROR, "Map_dv",
...
void SLIArrayModule::IMapIndexedFunction::backtrace(SLIInterpreter *i,
                                                    int p) const {
  IntegerDatum *id = static_cast<IntegerDatum *>(i->EStack.pick(p + 3).datum());
  assert(id != NULL);
...
void SLIArrayModule::IMapThreadFunction::backtrace(SLIInterpreter *i,
                                                   int p) const {
  IntegerDatum *id = static_cast<IntegerDatum *>(i->EStack.pick(p + 3).datum());
  assert(id != NULL);
...
void SLIArrayModule::Put_a_a_tFunction::execute(SLIInterpreter *i) const {
  if (i->OStack.load() < 3) {
    ...
    i->message(SLIInterpreter::M_ERROR, "Put",
...
void SLIArrayModule::AreaFunction::execute(SLIInterpreter *i) const {
  if (i->OStack.load() < 7) {
    ...
    i->message(SLIInterpreter::M_ERROR, "area",
               "Usage: sw say sax  ah aw aay aax  area");
    i->message(SLIInterpreter::M_ERROR, "area",
               "where:  sw : source array width");
    i->message(SLIInterpreter::M_ERROR, "area",
...
void SLIArrayModule::Area2Function::execute(SLIInterpreter *i) const {
  if (i->OStack.load() < 6) {
    i->message(SLIInterpreter::M_ERROR, "area2",
...
void SLIArrayModule::GetMaxFunction::execute(SLIInterpreter *i) const {
  if (i->OStack.load() < 1) {
    i->message(SLIInterpreter::M_ERROR, "GetMax",
               "Too few parameters supplied.");
...
void SLIArrayModule::GetMinFunction::execute(SLIInterpreter *i) const {
  if (i->OStack.load() < 1) {
    i->message(SLIInterpreter::M_ERROR, "GetMin",
               "Too few parameters supplied.");
...
void SLIArrayModule::GaborFunction::execute(SLIInterpreter *i) const {
  ...
  if ((ncol < 2) || (nrow < 2)) {
    i->message(SLIInterpreter::M_ERROR, "Gabor_",
...
void SLIArrayModule::Gauss2dFunction::execute(SLIInterpreter *i) const {
  ...
  if ((ncol < 2) || (nrow < 2)) {
    i->message(SLIInterpreter::M_ERROR, "gauss2d_",
               "Matrix must have at least two rows and two columns.");
    i->raiseerror("RangeCheck");
    return;
  }
...
void SLIArrayModule::Array2DoubleVectorFunction::execute(
...
void SLIArrayModule::Add_iv_ivFunction::execute(SLIInterpreter *i) const {
  ...
  if ((*ivd1)->size() != (*ivd2)->size()) {
    i->message(SLIInterpreter::M_ERROR, "add_iv_iv",
...
void SLIArrayModule::Sub_iv_ivFunction::execute(SLIInterpreter *i) const {
  ...
  if ((**ivd1).size() != (**ivd2).size()) {
    i->message(SLIInterpreter::M_ERROR, "sub_iv_iv",
...
void SLIArrayModule::Mul_iv_ivFunction::execute(SLIInterpreter *i) const {
  ...
  if ((**ivd1).size() != (**ivd2).size()) {
    i->message(SLIInterpreter::M_ERROR, "mul_iv_iv",
...
void SLIArrayModule::Div_iv_ivFunction::execute(SLIInterpreter *i) const {
  ...
  if ((**ivd1).size() != (**ivd2).size()) {
    i->message(SLIInterpreter::M_ERROR, "div_iv_iv",
  ...
  for (size_t j = 0; j < length; ++j) {
    ...
    if (quotient == 0) {
      delete result;
      i->message(SLIInterpreter::M_ERROR, "div_iv",
                 "Vector element zero encountered.");
...
void SLIArrayModule::Add_dv_dvFunction::execute(SLIInterpreter *i) const {
  ...
  if ((**dvd1).size() != (**dvd2).size()) {
    i->message(SLIInterpreter::M_ERROR, "add_dv_dv",
               "You can only add vectors of the same length.");
    i->raiseerror("RangeCheck");
  }
...
void SLIArrayModule::Sub_dv_dvFunction::execute(SLIInterpreter *i) const {
  ...
  if ((**dvd1).size() != (**dvd2).size()) {
    i->message(SLIInterpreter::M_ERROR, "sub_dv_dv",
               "You can only subtract vectors of the same length.");
    i->raiseerror("RangeCheck");
  }
...
void SLIArrayModule::Inv_dvFunction::execute(SLIInterpreter *i) const {
  ...
  for (size_t j = 0; j < length; ++j) {
    ...
    if (val * val < 1.0e-100) {
      delete result;
      i->message(SLIInterpreter::M_ERROR, "inv_dv",
...
void SLIArrayModule::Mul_dv_dvFunction::execute(SLIInterpreter *i) const {
  ...
  if ((**dvd1).size() != (**dvd2).size()) {
    i->message(SLIInterpreter::M_ERROR, "mul_dv_dv",
               "You can only multiply vectors of the same length.");
    i->raiseerror("RangeCheck");
  }
...
void SLIArrayModule::Div_dv_dvFunction::execute(SLIInterpreter *i) const {
  ...
  for (size_t j = 0; j < length; ++j) {
    ...
    if (quotient * quotient < 1e-100) {
      delete result;
      i->message(SLIInterpreter::M_ERROR, "div_dv",
                 "Vector element (near) zero encountered.");
      i->raiseerror("DivisionByZero");
      return;
    }
...
void SLIArrayModule::DoubleVector2ArrayFunction::execute(
    SLIInterpreter *i) const {
  if (i->OStack.load() < 1) {
    i->raiseerror(i->StackUnderflowError);
    return;
...
void SLIArrayModule::Iforall_ivFunction::backtrace(SLIInterpreter *i,
                                                   int p) const {
  IntegerDatum *count =
...
void SLIArrayModule::Iforall_dvFunction::backtrace(SLIInterpreter *i,
                                                   int p) const {
  IntegerDatum *count =
      static_cast<IntegerDatum *>(i->EStack.pick(p + 3).datum());
  assert(count != NULL);
...
/** @BeginDocumentation
   ...
   Author: Peyser
 */
template <class T, class D> static void eq_execute(SLIInterpreter *i) {
  if (i->OStack.load() < 2) {
    i->raiseerror(i->StackUnderflowError);
    return;
  }
