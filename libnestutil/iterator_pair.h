...
inline IteratorPair<sort_iter_type_, perm_iter_type_>::IteratorPair(
    sort_iter_type_ sort_iter, perm_iter_type_ perm_iter)
    : sort_iter_(sort_iter), perm_iter_(perm_iter) {}

template <typename sort_iter_type_, typename perm_iter_type_>
inline void IteratorPair<sort_iter_type_, perm_iter_type_>::increment() {
  ++sort_iter_;
  ++perm_iter_;
}

template <typename sort_iter_type_, typename perm_iter_type_>
inline void IteratorPair<sort_iter_type_, perm_iter_type_>::decrement() {
  --sort_iter_;
  --perm_iter_;
}

template <typename sort_iter_type_, typename perm_iter_type_>
inline bool IteratorPair<sort_iter_type_, perm_iter_type_>::equal(
    IteratorPair const &other) const {
  return (sort_iter_ == other.sort_iter_);
}

template <typename sort_iter_type_, typename perm_iter_type_>
inline void IteratorPair<sort_iter_type_, perm_iter_type_>::advance(
    typename iterator_pair_types<sort_iter_type_,
